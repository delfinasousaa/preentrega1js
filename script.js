...
while (intentos < 3) {
    ...
    if (entrada === "GENERAL") {
        ...
        //mientras q sean menores los intentos a 3, pregunto entradas
        ...
        if (intentosEntradas === 3) {
            ...
            // mientras q no sea SI o NO, ni los 3 intentos, aviso y no continuo
            ...
            if (abonar === "SI" || abonar === "S") {
                let mail=prompt("Ingresa tu correo electronico y se te enviara un enlace para realizar el pago");
                alert("¡Gracias!");
    ...
    //si es VIP
        ...
        if (intentosEntradas === 3) {
            alert("Has alcanzado el máximo de intentos para ingresar el número de entradas, intentalo mas tarde");
        } 
        else {
